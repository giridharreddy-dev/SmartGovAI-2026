...
(function () {
    ...
    const TRANSLATIONS = {
        te: {
            ...
            pdfProcTitle: 'పత్రాన్ని అర్థం చేసుకుంటున్నాము...',
            pdfProcDesc: 'SmartGov AI మీ కోసం సమాచారాన్ని సరళీకరిస్తుంది.',
            pdfProcRead: 'మీ పత్రం చదువుతున్నాం...',
            pdfProcExtract: 'ముఖ్యమైన వివరాలు వెతుకుతున్నాం...',
            pdfProcTranslate: 'తెలుగులోకి మారుస్తున్నాం...',
            pdfProcAudio: 'సమాధానం సిద్ధం చేస్తున్నాం... ',
        ...
        en: {
            ...
            mapType: 'Type:',
            mapSearchPlaceholder: '🔍 Search name, village...',
            ...
            pdfProcTitle: 'Understanding your document',
            pdfProcDesc: 'SmartGov AI is simplifying the information for you.',
            pdfProcRead: 'Reading your document...',
            pdfProcExtract: 'Extracting key details...',
            pdfProcTranslate: 'Simplifying the language...',
            pdfProcAudio: 'Preparing your result...',
